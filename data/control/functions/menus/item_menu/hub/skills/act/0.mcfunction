#> control:menus/item_menu/hub/skills/act/0
#
# 設定を変更したり、アイコンの内容を変更したりする
#

## Skillのページを表示する
execute store result score $Move ArrayUtilInput run scoreboard players operation @s ItemMenuPages = $Skills ItemMenuPages
