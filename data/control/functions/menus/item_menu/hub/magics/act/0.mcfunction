#> control:menus/item_menu/hub/magics/act/0
#
# 設定を変更したり、アイコンの内容を変更したりする
#

## Magicのページを表示する
execute store result score $Move ArrayUtilInput run scoreboard players operation @s ItemMenuPages = $Magics ItemMenuPages
